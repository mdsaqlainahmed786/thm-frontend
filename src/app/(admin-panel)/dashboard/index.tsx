    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      ...
      <Link href={"/reports"}>
        <CardDataStats
          ...
          levelUp={Math.sign(data?.statistics?.reports?.percentage ?? 0) === +1}
        >
          <svg
            width="26"
            height="26"
