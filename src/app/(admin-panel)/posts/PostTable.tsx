...
const PostTable = () => {
  ...
  useEffect(() => {
    setPageNo(1);
  }, [apiParams.postType, apiParams.sortBy]);
  useEffect(() => {
    if (data) {
  ...
  return (
    <div className="col-span-12 xl:col-span-7">
      <div className="rounded-sm border border-stroke bg-white px-5  py-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="flex items-center flex-wrap gap-2">
              ...
              <button
                type="button"
                onClick={(e) => setApiParams({ ...apiParams, postType: "" })}
                className={`${
                  apiParams.postType === ""
                    ? "border-primary bg-primary text-white "
                    : " border-stroke"
                }  border inline-flex px-2 py-1 font-medium text-sm  hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:text-white dark:hover:border-primary sm:px-6 sm:py-2`}
              >
                All
              </button>
              <button
                type="button"
                onClick={(e) =>
                  setApiParams({ ...apiParams, postType: "post" })
                }
                className={`${
                  apiParams.postType === "post"
                    ? "border-primary bg-primary text-white "
                    : " border-stroke"
                } border-y inline-flex px-2 py-1 font-medium text-sm  hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:text-white dark:hover:border-primary sm:px-6 sm:py-2`}
              >
                Post
              </button>
              <button
                type="button"
                onClick={(e) =>
                  setApiParams({ ...apiParams, postType: "event" })
                }
                className={`${
              ...
              <button
                type="button"
                onClick={(e) =>
                  setApiParams({ ...apiParams, postType: "review" })
                }
                className={`${
                  apiParams.postType === "review"
                    ? "border-primary bg-primary text-white "
                    : " border-stroke"
                } border-s-0 border inline-flex px-2 py-1 font-medium text-sm  hover:border-primary hover:bg-primary hover:text-white dark:border-strokedark dark:text-white dark:hover:border-primary sm:px-6 sm:py-2`}
              >
                Review
              </button>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="relative z-20 bg-white dark:bg-form-input">
                ...
                <select
                  className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-10 py-2 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input text-black dark:text-white text-sm min-w-[150px] cursor-pointer dark:bg-boxdark"
                  value={apiParams.sortBy}
                  onChange={(e) =>
        ...
        <div className="max-w-full overflow-x-auto -mx-5 sm:mx-0">
          <div
            className={`${
              mediaModel ? "" : "hidden"
                  ...
                  >
                    {media &&
                      media.map((data, index) => (
                        <SwiperSlide
                          key={index}
                          className="!flex justify-center !bg-black/60 !w-100 !h-100 rounded-lg overflow-hidden relative"
                        >
              ...
              <form onSubmit={handleFormSubmit}>
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormInputs({ ...formInputs, content: e.target.value })
                    }
                  ></textarea>
                </div>
                      ...
                      {formInputs.type === "online" ? (
                        <div className="mb-3">
                          ...
                          <input
                            ...
                            type="text"
                            name="streamingLink"
                            value={formInputs.streamingLink}
                            onChange={(e) =>
                              setFormInputs({
                                ...formInputs,
                                streamingLink: e.target.value,
                              })
                            }
                          />
                        </div>
                ...
                <div className="mb-3 flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="pt-3">
                      <SwitcherThree
                        id="isPublished"
                        enabled={formInputs.isPublished}
                        setEnabled={(e) =>
                          setFormInputs({
                            ...formInputs,
                            isPublished: !formInputs.isPublished,
                          })
                        }
                      />
                    </div>
                        ...
                        <tr key={key}>
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark gap-1.5 max-w-70 ">
                            <h5 className="truncate">
                              <span
                                className="text-sm font-bold tracking-wide capitalize text-meta-4 dark:text-meta-9"
                                title="Post Type"
                              >
                            ...
                            {data.postType === "review" ? (
                              <div className="flex gap-1">
                                {Array.from({ length: data.rating ?? 0 }).map(
                                  (_, index) => (
                                    <div key={index}>
                                      <svg
                                        className="w-5 h-5 fill-meta-8"
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                      >
                                        <g clipPath="url(#clip0_771_10385)">
                                          <path
                                            d="M12.0001 2L15.1041 8.728L22.4621 9.601L17.0221 14.631L18.4661 21.899L12.0001 18.28L5.53409 21.9L6.97809 14.632L1.53809 9.6L8.89709 8.727L12.0001 2Z"
                                            stroke="black"
                                            strokeWidth="2.5"
                                            strokeLinejoin="round"
                                          />
                          ...
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark xl:pl-2">
                            <UserDetailedView
                              ...
                              accountType={
                                data.postedBy && data.postedBy.accountType
                              }
                              image={
                                data.postedBy &&
                                data.postedBy.profilePic &&
                                data.postedBy.profilePic.small
                                  ? data.postedBy.profilePic.small
                                  : undefined
                              }
                          ...
                          {apiParams.postType === "event" ? (
                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                              <div>
                                ...
                                {currentDate < new Date(eventStartTime) ||
                                currentDate < new Date(eventEndTime) ? (
                                  <p className="text-xs capitalize text-meta-3 dark:text-white">
                                    Event is coming soon!
                                  </p>
                                ) : currentDate > new Date(eventEndTime) ? (
                                  <p className="text-xs capitalize text-meta-1 dark:text-white">
                                    Event Closed
                                  </p>
                                ) : (
                                  <p className="text-xs capitalize text-meta-6 dark:text-white">
                                    Live
                                  </p>
                                )}
                              </div>
                          ...
                          {apiParams.postType === "review" ? (
                            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                              <UserDetailedView
                                id={
                                  data &&
                                  data.reviewedBusinessProfileRef &&
                                  data.reviewedBusinessProfileRef._id
                                    ? data.reviewedBusinessProfileRef._id
                                    : "-"
                                }
                                name={
                                  data &&
                                  data.reviewedBusinessProfileRef &&
                                  data.reviewedBusinessProfileRef.name
                                    ? data.reviewedBusinessProfileRef.name
                                    : "-"
                                }
                                username={
                                  data &&
                                  data.reviewedBusinessProfileRef &&
                                  data.reviewedBusinessProfileRef.username
                                    ? data.reviewedBusinessProfileRef.username
                                    : "-"
                                }
                                accountType={
                                  data &&
                                  data.reviewedBusinessProfileRef &&
                                  data.reviewedBusinessProfileRef.accountType
                                    ? data.reviewedBusinessProfileRef
                                        .accountType
                                    : "-"
                                }
                                image={
                                  data.reviewedBusinessProfileRef &&
                                  data.reviewedBusinessProfileRef.profilePic &&
                                  data.reviewedBusinessProfileRef.profilePic
                                    .small
                                    ? data.reviewedBusinessProfileRef.profilePic
                                        .small
                                ...
                                register={
                                  !data.googleReviewedBusiness ? false : true
                                }
                              />
                            </td>
                          ) : null}
                          ...
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            {data.isPublished ? (
                              <span className="text-meta-3 text-xs font-bold tracking-wide">
                                Published
                              </span>
                            ) : (
                              <span className="text-meta-4 text-xs tracking-wide dark:text-meta-9">
                                Unpublished
                              </span>
                            )}
                          </td>
                          ...
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <div className="flex items-center space-x-3.5">
                              <button
                                ...
                                disabled={
                                  data.mediaRef && data.mediaRef.length === 0
                                }
                                onClick={() => {
                                  setMediaModel(true);
