                    ...
                    >
                      <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <div className="flex items-center gap-4">
                          <div className="h-12 w-12 rounded-full bg-gray-200 dark:bg-boxdark-hover animate-pulse"></div>
                        ...
                        <tr key={key}>
                          ...
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark xl:pl-2">
                            <UserDetailedView
                              ...
                              username={
                                data.postedBy && data.postedBy.username
                                  ? data.postedBy.username
                                  : "-"
                              }
                              accountType={
                                data.postedBy && data.postedBy.accountType
                                  ? data.postedBy.accountType
                                  : ""
                              }
                              image={
                                data.postedBy &&
                          ...
                          <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <UserDetailedView
                              ...
                              image={
                                ...
                                data.reviewedBusinessProfileRef.profilePic.small
                                  ? data.reviewedBusinessProfileRef.profilePic
                                      .small
                                  : undefined
                              }
