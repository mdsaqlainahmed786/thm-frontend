        ...
        <>
            <HotelAdminLayout isSearchable={false}>
                ...
                <div className='flex justify-center mt-8'>
                    <button onClick={
                        () => reset()
                    } className="inline-flex items-center justify-center gap-2.5 rounded-md bg-primary/50 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10" >
                        <span>
