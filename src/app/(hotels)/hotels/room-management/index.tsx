...
export default function RoomManagement() {
    ...
    const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        try {
            ...
            fromData.append("totalRooms", parseInt(formInputs?.totalRooms?.toString()) as any);
    ...
    return (
        <>
                            ...
                            <div className="my-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="mb-3">
                                        ...
                                        <Input id="title" name="title" required={true} value={formInputs.title} onChange={(e) => setFormInputs({ ...formInputs, title: e.target.value })} placeholder="Room title" />
                                    </div>
                                    <div className="mb-3">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="mb-3">
                                        ...
                                        <div className="relative z-20 ">
                                            ...
                                            <select id="children" className="relative z-20 w-full appearance-none rounded-theme-xl border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-primary active:border-primary dark:border-theme-gray-1 dark:bg-form-input text-white dark:text-white text-sm" required={true} onChange={(e) => setFormInputs({ ...formInputs, children: parseInt(e.target.value) })} value={formInputs.children}>
                                                <option value={0} className="text-black dark:text-black">Select capacity</option>
                                                {
                                                    [1, 2, 3, 4].map((data) => (
                                                        <option key={data} value={data} className="text-black dark:text-black">{data}</option>
                                                    ))
                                                }
                                            </select>
                                            <span className="absolute right-4 top-1/2 z-10 -translate-y-1/2">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="relative z-20 ">
                                            ...
                                            <select id="children" className="relative z-20 w-full appearance-none rounded-theme-xl border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-primary active:border-primary dark:border-theme-gray-1 dark:bg-form-input text-white dark:text-white text-sm" required={true} onChange={(e) => setFormInputs({ ...formInputs, adults: parseInt(e.target.value) })} value={formInputs.adults}>
                                                <option value="" disabled={false} className="text-black dark:text-black">Select capacity</option>
                                                {
                                                    [1, 2, 3, 4].map((data) => (
                                                        <option key={data} value={data} className="text-black dark:text-black">{data}</option>
                                                    ))
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="mb-3">
                                        ...
                                        <Input step={0.01} type="number" id="price" name="price" value={formInputs.price.toString()} onChange={(e) => setFormInputs({ ...formInputs, price: parseFloat(e.target.value) })} placeholder="Base Price" />
                                    </div>
                                    <div className="mb-3">
                                        ...
                                        <div className="relative z-20 ">
                                            ...
                                            <select className="relative z-20 w-full appearance-none rounded-theme-xl border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-primary active:border-primary dark:border-theme-gray-1 dark:bg-form-input text-white dark:text-white text-sm placeholder-white/60" required={true} onChange={(e) => setFormInputs({ ...formInputs, bedType: e.target.value })} value={formInputs.bedType}>
                                                <option value="" disabled={false} className="text-black dark:text-black">Select Bed Type</option>
                                                {
                                                    bedTypes && bedTypes.map((data, index) => (
                                                        <option key={index} value={data.value} className="text-black dark:text-black">{data.name}</option>
                                                    ))
                                                }
                                            </select>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="mb-3">
                                        ...
                                        <div className="relative z-20 ">
                                            ...
                                            <select className="relative z-20 w-full appearance-none rounded-theme-xl border border-stroke bg-form-input px-12 py-3 outline-none transition focus:border-primary active:border-primary dark:border-theme-gray-1 dark:bg-form-input text-white dark:text-white text-sm dark:placeholder-gray-400" required={true} onChange={(e) => setFormInputs({ ...formInputs, mealPlan: e.target.value })} value={formInputs.mealPlan}>
                                                <option value="" disabled={false} className="text-black dark:text-black">Select Meal Plan</option>
                                                {
                                                    mealTypes && mealTypes.map((data, index) => (
                                                        <option key={index} value={data.value} className="text-black dark:text-black">{data.name}</option>
                                                    ))
                                                }
                                            </select>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <Input step={1} type="number" id="totalRooms" name="totalRooms" value={formInputs.totalRooms.toString()} onChange={(e) => setFormInputs({ ...formInputs, totalRooms: parseFloat(e.target.value) })} placeholder="Enter total rooms" />
                                    </div>
                                </div>
                                <div>
                                    <div className="mb-3">
                                        ...
                                        <div className="relative z-20 ">
                                            ...
                                            <div className="relative z-20 w-full appearance-none rounded-theme-xl border border-stroke bg-transparent px-8 py-1 outline-none transition focus:border-primary active:border-primary dark:border-theme-gray-1 dark:bg-form-input text-white dark:text-white text-sm">
                                                <Select
                                                    ...
                                                    options={amenities && amenities.length !== 0 ?
                                                        amenities && amenities.map((data) => ({ value: data._id, label: data.name })) :
                                                        []}
                                                    value={formInputs.amenities}
                                                    onChange={(newValue, actionMeta) => changeAminity(newValue, actionMeta)}
                                                />
                                            </div>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between items-center">
                ...
                <div>
                    <Button.Hotel.Button name="Add Room" onClick={() => {
                        setModal(!modal);
                        setFormInputs(initialFormInputs);
                        setEditMode(false);
                                                            ...
                                                            <td className="px-1 py-2 group-last:first:rounded-bl-xl group-last:last:rounded-br-xl">
                                                                <div className="flex gap-2">
                                                                    <Button.Hotel.Edit name="Edit" svg={<SVG.Edit />} onClick={() => {
                                                                        const selectedAmenities = amenities && amenities?.length !== 0 ?
                                                                            amenities.filter((amenityID) => room?.amenities.includes(amenityID._id.toString()))
                                                                                .map((data) => {
                                                                                    return {
                                                                                        value: data._id,
                                                                                        label: data.name
                                                                    ...
                                                                    <Button.Hotel.Delete name="Delete" svg={<SVG.Delete />} onClick={() => handleDelete(room?._id)} />
                                                                </div>
                                                            </td>
                                                            <td className="px-1 py-2 group-last:first:rounded-bl-xl group-last:last:rounded-br-xl">
                                                                <div className="inline-flex p-2 gap-2 items-center bg-primary/50 bg-blur-[35px] rounded-[24px]">
                                                                    <button disabled={(room?.totalRooms && room.totalRooms <= 1) ? true : false} type="button" className={`${(room?.totalRooms && room.totalRooms <= 1) ? 'opacity-60' : ''} bg-primary flex gap-1 p-1 justify-center items-center rounded-3xl`} onClick={() => changeInventory(room._id, room?.totalRooms - 1)}>
                                                                    ...
                                                                    <span className="text-sm font-normal font-comic-sans">{room?.totalRooms}</span>
                                                                    <button type="button" className="bg-primary flex gap-1 p-1 justify-center items-center rounded-3xl" onClick={() => changeInventory(room._id, room?.totalRooms + 1)}>
                                                                        <div className="w-5 h-5 rounded-full flex justify-center items-center">
                                                                            <span>
