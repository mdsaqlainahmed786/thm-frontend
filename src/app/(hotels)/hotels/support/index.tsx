        ...
        <>
            ...
            <PageContent>
                ...
                <div className="flex w-full border-b border-white/10 mb-4">
                    <button 
                        className={`flex-1 py-3 px-4 relative font-comic-sans transition-colors duration-200 ${
                    ...
                    currentTab === "contact-us" ?
                        <form className="flex flex-col gap-4 pt-2" onSubmit={handleSubmit}>
                            ...
                            <a 
                                ...
                                className="rounded-xl border border-theme-gray bg-theme-black px-4 py-4 shadow-default dark:border-theme-gray dark:bg-theme-black hover:border-primary/50 transition-colors duration-200 cursor-pointer group"
                            >
                            ...
                            <div className="flex items-center gap-3 my-2">
                                ...
                                <p className="text-xs font-medium text-white/40 uppercase tracking-wider">Or send us a message</p>
                                <div className="flex-1 h-px bg-white/10"></div>
                            </div>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex flex-col gap-1.5">
                                    <label htmlFor="name" className="text-sm font-medium text-white/70 dark:text-white/70">
                                        Name
                                    </label>
                                    <input 
                                        id="name" 
                                        className="text-sm font-normal text-white w-full rounded-xl border border-theme-gray bg-theme-black px-4 py-3 shadow-default dark:border-theme-gray dark:bg-theme-black outline-0 focus:border-primary transition-colors duration-200 placeholder:text-white/40" 
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <label htmlFor="email" className="text-sm font-medium text-white/70 dark:text-white/70">
                                        Email
                                    </label>
                                    <input 
                                        id="email" 
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label htmlFor="message" className="text-sm font-medium text-white/70 dark:text-white/70">
                                    Message
                                </label>
                                <textarea 
                                    rows={4} 
                                    id="message" 
                                    className="text-sm font-normal text-white w-full rounded-xl border border-theme-gray bg-theme-black px-4 py-3 shadow-default dark:border-theme-gray dark:bg-theme-black outline-0 focus:border-primary transition-colors duration-200 resize-none placeholder:text-white/40" 
                            ...
                            <div className="flex justify-end pt-2">
                                <button 
                                    type="submit"
                                    className="text-sm font-medium px-6 py-2.5 bg-primary text-white rounded-full hover:bg-primary/90 transition-colors duration-200 active:scale-95 min-w-[120px]" 
                                >
                                    Send Message
                                </button>
                            </div>
