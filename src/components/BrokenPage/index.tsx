                ...
                <div className="no-scrollbar overflow-y-auto py-20">
                    <div className="mx-auto w-full max-w-[600px]">
                        <div className="text-center">
                            ...
                            <h1 className="mb-2.5 text-3xl font-black text-black dark:text-white lg:text-4xl xl:text-[50px] xl:leading-[60px]">Sorry, this page isn't available.</h1>
                            <p className="font-medium">The link you followed may be broken, or the page may have been removed. Go back to Home.</p>
                        </div>
                    </div>
