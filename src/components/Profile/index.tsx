        ...
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <div>
              ...
              {profile && (
                <button
                  className="flex cursor-pointer items-center justify-center gap-2 rounded bg-meta-3 px-2 py-1 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4 ml-2"
