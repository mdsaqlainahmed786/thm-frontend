...
const Navbar = () => {
    ...
    return (
        ...
        <section className=" md:mt-auto">
            ...
            <nav className="flex sm:px-2.5 py-3 sm:bg-[#59595933] items-center justify-between backdrop-blur-[54px] rounded-[36px] m-3 sm:m-7 min-w-5xl">
                <div className="min-w-20 lg:min-w-46">
