    ...
    <>
      <li>
        <Link
          ...
          } group relative flex items-center rounded-sm font-medium text-bodydark1 transition-all duration-200 ease-in-out hover:bg-graydark dark:text-bodydark1 dark:hover:bg-boxdark-hover ${
