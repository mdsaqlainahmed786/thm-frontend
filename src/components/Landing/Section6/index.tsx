...
const Section6 = () => {
   ...
   const iconsLeftX = useSpring(
      useTransform(scrollY, [9701, 9800, 10200, 10201], [-700, 0, 0, -700]),
   ...
   const iconsDownY = useSpring(
      useTransform(scrollY, [9701, 9800, 10200, 10201], [1500, 0, 0, 1500]),
      { stiffness: 50, damping: 30 }
   );
   const iconsUpY = useSpring(
      useTransform(scrollY, [9701, 9800, 10200, 10201], [-1200, 0, 0, -1200]),
      { stiffness: 50, damping: 30 } 
   );
   return (
            ...
            <div className="flex justify-center flex-col items-center relative">
               ...
               >
                  ...
                  <div className="overflow-hidden">
                     ...
                     <motion.p className="text-center text-[22px] md:text-[36px] font-medium text-[#FFFFFF] leading-[40px] md:leading-[60px]"
                        initial={{ y: 100 }}
                        animate={{ y: scrollVal > 9800 ? 0 : 100 }}
                        transition={{
                           type: 'tween',
                           duration: 1.6,
                           delay: 1.7,
