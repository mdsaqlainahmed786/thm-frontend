            ...
            <div className="w-full order-2 md:basis-1/4 md:order-1">
                <div className="flex flex-col justify-around items-center h-full overflow-hidden">
                    <div className="h-39 overflow-hidden">
                        <motion.h2 className="font-bold text-[32px] leading-tight text-white text-center md:text-left"
                            initial={{ y: 200 }}
                            animate={{ y: prevScroll <= 500 ? 200 : 40 }}
                            transition={{
                                type: 'tween',
                                duration: .7,
                                delay: 0.3,
            ...
            <div className="w-full order-3 md:order-3 md:basis-1/4">
                <div className="flex flex-col justify-around items-center h-full overflow-hidden">
                    <div className="h-39 overflow-hidden">
                        <motion.h2 className="font-bold text-[32px] leading-tight text-white text-center md:text-left "
                            initial={{ y: 200 }}
                            animate={{ y: prevScroll <= 800 ? 200 : 40 }}
                            transition={{
                                type: 'tween',
                                duration: .7,
                                delay: .3,
                    ...
                    <div className="h-39 overflow-hidden">
                        <motion.p className="font-normal text-title-sm2 leading-tight text-white text-center md:text-left "
                            initial={{ y: 200 }}
                            animate={{ y: prevScroll <= 1100 ? 200 : 40 }}
                            transition={{
                                type: 'tween',
                                duration: .7,
                                delay: .3,
