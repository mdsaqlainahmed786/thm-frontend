...
const Section7 = () => {
   ...
   const iconsLeftX = useSpring(
      useTransform(scrollY, [8701, 8750], [-700, 0]),
      { stiffness: 50, damping: 30 }
   );

   const iconsRightX = useSpring(
      useTransform(scrollY, [8701, 8750, 9050], [1700, 0, 0]),
      { stiffness: 50, damping: 30 }
   );
   ...
   const iconsUpY = useSpring(
      useTransform(
         scrollY,
         [0, 8399, 8400, 8900, 8901, 9200, 9201],
         [-1200, -1200, 0, 0, -400, -400, -1200]
      ),
      { stiffness: 50, damping: 30 }
   );
   ...
   return (
      <motion.div
         ...
         style={{ y: deviceType !== "phone" ? iconsUpY : mobileIconsUpY }}
         transition={{
                  ...
                  <div className="flex flex-col gap-10">
...

                     {
                        ...
                        <motion.div className="min-w-46 text-left duration-1500 flex gap-3 items-center h-14"
                           initial={{ opacity: 0 }}
                           animate={{ opacity: scrollVal > 8750 ? 1 : 0 }}
